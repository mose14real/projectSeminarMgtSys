        ...
        <div class="row">
            ...
            <div class="col-md-6 content-register">
                <div class="overlay pt-4">
                    ...
                    <p class="text-white">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptatibus, enim tempore facere iure
                        voluptas minus expedita inventore odio! Facilis asperiores voluptatibus quos? Consequuntur
                        aspernatur delectus veniam debitis? Ex esse magnam iure, beatae, totam vitae provident maiores
                        reprehenderit perspiciatis eius expedita quod? Cum velit accusantium sequi unde
                    </p>
                    <a href="{{ url('/') }}">
                        <button class="btn btn-block shadow-none mb-3 explore-project-btn"><i class="bi bi-arrow-right">
                            </i>&nbsp;Explore More projects</button>
                    </a>
                </div>
            </div>
            ...
            <div class="col-md-6 pt-4 d-flex align-items-center justify-content-center flex-column form-register">
                ...
                <form class="mt-3" action="{{ url('auth-login') }}" method="POST">
                    ...
                    <p class="text-center">Don't have an Account?🤔 Kindly <a href="{{ url('register') }}">Register</a>
                    </p>
